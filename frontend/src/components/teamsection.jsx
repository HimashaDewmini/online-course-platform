...
const talents = [
	{
		...
		image: "/bestTalent/matthew-ryan.png",
	...
	},
	{
		...
		image: "/bestTalent/daniel-joseph.png",
		backgroundColor: "#FFD3E1",
	},
	{
		id: 3,
		...
		image: "/bestTalent/adam-bennett.png",
	...
	},
	{
		...
		name: "James Michael",
		role: "Digital Marketer",
		image: "/bestTalent/james-michael.png",
						...
						>
							...
							>
								<div className="text-center mb-10 mt-4 pt-4">
									<h3 className="text-xl font-medium text-[#011813]">
										{talent.name}
									</h3>
								...
								<div className="h-auto overflow-hidden ">
									<img
										...
										onError={(e) => {
											console.error(
												`Failed to load image: ${talent.image}`
											);
											e.target.src =
